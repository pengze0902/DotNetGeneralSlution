...
namespace AuxiliaryLibrary.VerificationCode
{
    /// <summary>
    /// 生成验证码的类
    /// </summary>
    public class VerificationCode
    {
        ...
        public string CreateValidateCode(int length)
        {
            ...
            {
                throw new ArgumentException($"验证码长度必须在[{MinLength},{MaxLength}]的范围内");
            }
            ...
            for (int i = 0; i < length; i++)
            {
                string numStr = Math.Abs(randMembers[i]).ToString();
        ...
        /// <returns>图片数据流（MemoryStream）</returns>
